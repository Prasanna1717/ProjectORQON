      ...
      {displayTrades.length === 0 ? (
        ...
        <div className="space-y-3">
          {displayTrades.map((trade, idx) => (
            <Tile 
              key={idx}
              className="border border-blue-600/40 bg-gray-800/70 backdrop-blur-sm hover:bg-gray-800/90 hover:border-blue-500/50 transition-all duration-300 shadow-[inset_0_-30px_50px_-15px_rgba(59,130,246,0.12)]"
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tag type={trade.action === 'BUY' ? 'green' : 'red'}>
                    {trade.action}
                  </Tag>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold">{trade.order_type}</p>
                </div>
                {trade.price && (
                  <div>
