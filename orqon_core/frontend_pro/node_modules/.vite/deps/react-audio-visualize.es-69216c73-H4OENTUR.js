...
function mr() {
  return Pe || (Pe = 1, (function() {
    ...
    var xe = false, Fe = false, Ne = false, Ae = false, Ie = false, oe;
...
` + c[S].replace(" at new ", " at ");
        ...
        K = false, X.current = v, Me(), Error.prepareStackTrace = p;
      }
    ...
    function qe(e, r, t, n, p) {
      {
        ...
        for (var u in e)
          if (v(e, u)) {
            ...
            c && !(c instanceof Error) && (V(p), f("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, u, typeof c), V(null)), c instanceof Error && !(c.message in me) && (me[c.message] = true, V(p), f("Failed %s type: %s", t, c.message), V(null));
          }
      }
    }
    ...
    function Ge(e, r) {
      {
        var t = function() {
          be || (be = true, f("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function er(e, r) {
      {
        var t = function() {
          we || (we = true, f("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
...
false ? ne.exports = dr() : ne.exports = mr();
var $e = ne.exports;
var gr = (y, m, _, b) => {
...
var Sr = ({
  ...
  const [a] = (0, import_react.useState)(() => new AudioContext()), [d, E] = (0, import_react.useState)(), C = (0, import_react.useRef)(null);
  ...
  }, [y.stream]), (0, import_react.useEffect)(() => {
...
var br = (0, import_react.forwardRef)(
  ({
    blob: y,
    width: m,
    height: _,
    ...
    const a = (0, import_react.useRef)(null), [d, E] = (0, import_react.useState)([]), [C, T] = (0, import_react.useState)(0);
    return (0, import_react.useImperativeHandle)(
      o,
      () => a.current,
      []
    ), (0, import_react.useEffect)(() => {
    ...
    }, [y, a.current]), (0, import_react.useEffect)(() => {
      a.current && te(
        d,
        a.current,
        b,
...
react-audio-voice-recorder/dist/react-audio-visualize.es-69216c73.js:
  (**
   * @license React
...
react-audio-voice-recorder/dist/react-audio-visualize.es-69216c73.js:
   ...
   *)
*/
//# sourceMappingURL=react-audio-visualize.es-69216c73-H4OENTUR.js.map
