...
function ne(o) {
  ...
  if (typeof f == "function") {
    ...
    s = {};
  return Object.defineProperty(s, "__esModule", { value: true }), Object.keys(o).forEach(function(p) {
...
(function(o) {
  var f = (function(s) {
    ...
    s.isGeneratorFunction = function(t) {
      ...
      (e.displayName || e.name) === "GeneratorFunction" : false;
    }, s.mark = function(t) {
    ...
    function u(t) {
      this.tryEntries = [{ tryLoc: "root" }], t.forEach(x, this), this.reset(true);
    }
    s.keys = function(t) {
      var e = [];
      for (var r in t)
      ...
      return e.reverse(), function i() {
        for (; e.length; ) {
          var n = e.pop();
          if (n in t)
            return i.value = n, i.done = false, i;
        }
      ...
      if (t) {
        ...
        if (!isNaN(t.length)) {
          var r = -1, i = function n() {
            for (; ++r < t.length; )
              if (c.call(t, r))
                return n.value = t[r], n.done = false, n;
            return n.value = l, n.done = true, n;
          };
          return i.next = i;
        }
      }
    ...
    return u.prototype = {
      constructor: u,
      reset: function(t) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = l, this.done = false, this.delegate = null, this.method = "next", this.arg = l, this.tryEntries.forEach(a), !t)
          for (var e in this)
...
var fe = "@ffmpeg/ffmpeg";
var ce = "0.11.6";
var le = "FFmpeg WebAssembly version";
var pe = "src/index.js";
var ue = "src/index.d.ts";
var he = {
  example: "examples"
};
var de = {
...
var ye = "Jerome Wu <jeromewus@gmail.com>";
var ve = "MIT";
var be = {
...
var Ee = "https://github.com/ffmpegwasm/ffmpeg.wasm#readme";
var je = {
  "is-url": "^1.2.4",
  "node-fetch": "^2.6.1",
...
var Oe = typeof process < "u" && true ? new URL("/node_modules/@ffmpeg/core/dist/ffmpeg-core.js", self.location).href : `https://unpkg.com/@ffmpeg/core@${Q.devDependencies["@ffmpeg/core"].substring(1)}/dist/ffmpeg-core.js`;
var Se = { corePath: Oe };
var Z = false;
var X = () => {
};
...
var ee = ne(Ae);
var { defaultArgs: Ne, baseOptions: Ge } = ae;
var Ue = se;
var { defaultOptions: De, getCreateFFmpegCore: Me } = ee;
var { version: Ie } = Q;
var J = Error("ffmpeg.wasm is not ready, make sure you have completed load().");
var We = (o = {}) => {
  const {
    log: f,
    logger: s,
  ...
  let l = null, j = null, y = null, m = null, v = false, w = () => {
  }, C = f, N = p, _ = 0, G = 0, U = false, P = 0;
  const L = (a) => {
    a === "FFMPEG_END" && y !== null && (y(), y = null, m = null, v = false);
  }, O = (a, u) => {
    ...
    if (typeof a == "string")
      if (a.startsWith("  Duration")) {
        ...
        u({ duration: g, ratio: P }), (_ === 0 || _ > g) && (_ = g, U = true);
...
//# sourceMappingURL=index-1c988149-2EB4XF6M.js.map
